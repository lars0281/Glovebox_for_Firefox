...
function Paste_GloveboxSecureKeyOfferToken(request, sender, sendResponse) {
	

    var replacementStr = request.Paste_GloveboxSecureKeyOfferToken_text;
    console.log("Paste_GloveboxSecureKeyOfferToken.js JSON(request): " + JSON.stringify(request));
...
var startNode = sel.getRangeAt(i).startContainer;
    ...
    console.log("Paste_GloveboxSecureKeyOfferToken.js startNode: " + startNode);
    console.log("Paste_GloveboxSecureKeyOfferToken.js startNode.nodeType: " + startNode.nodeType);
	var nodetext = startNode.textContent;
    console.log("Paste_GloveboxSecureKeyOfferToken.js startNode.textContent: " + nodetext);
	var position = sel.getRangeAt(i).startOffset;
    console.log("Paste_GloveboxSecureKeyOfferToken.js sel.getRangeAt(i).startOffset : " + position );
...
browser.runtime.onMessage.addListener(Paste_GloveboxSecureKeyOfferToken);
