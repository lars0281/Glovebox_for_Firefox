...
function loadFromIndexedDB_async(dbName, storeName, id) {
	console.debug("loadFromIndexedDB_async:0");
	console.debug("loadFromIndexedDB_async:1 " + dbName);
	console.debug("loadFromIndexedDB_async:2 " + storeName);
	console.debug("loadFromIndexedDB_async:3 " + id);
			...
			try {
				...
				objectRequest.onsuccess = function(event) {
					if (objectRequest.result) {
						console.debug("loadFromIndexedDB_async:result " + JSON.stringify(objectRequest.result));
