...
function Get_AcceptedGloveboxSecureKeyOfferToken(request, sender, sendResponse) {

    var replacementStr = request.AcceptedGloveboxSecureKeyOfferToken_replacement;
    console.log("AcceptToken_secure: JSON(request): " + JSON.stringify(request));

    console.log("AcceptToken_secure: replacement text: " + replacementStr);
        ...
        if (typeof window.getSelection != "undefined") {
            ...
            if (sel.rangeCount) {
                ...
                for (var i = 0, len = sel.rangeCount; i < len; ++i) {
                    ...
                    console.log("AcceptGloveboxSecureKeyOfferToken.js: sel.getRangeAt(i).commonAncestorContainer: " + sel.getRangeAt(i).commonAncestorContainer);
                    console.log("AcceptGloveboxSecureKeyOfferToken.js: sel.getRangeAt(i).commonAncestorContainer.textContent: " + sel.getRangeAt(i).commonAncestorContainer.textContent);
                    ...
                    const glovebox_header_regex = new RegExp('(:GloveboxAcceptedSecureKeyOfferToken:[^:]*:)', 'm');
                    ...
                    if (sel.getRangeAt(i).commonAncestorContainer) {
                        ...
                        if (sel.getRangeAt(i).commonAncestorContainer.nodeType != 1) {
                            ...
                            console.log("AcceptGloveboxSecureKeyOfferToken.js: previous_text: " + previous_text);
                            console.log("AcceptGloveboxSecureKeyOfferToken.js: following_text: " + following_text);

                            if (sel.getRangeAt(i).commonAncestorContainer.nodeType == 1) {
                                full_text = sel.getRangeAt(i).commonAncestorContainer.textContent;
                                console.log("AcceptGloveboxSecureKeyOfferToken.js: YYYYY ");

                            } else {
                                console.log("AcceptGloveboxSecureKeyOfferToken.js: ZZZZZ ");

                                if (typeof previous_text != "undefined") {
                                    console.log("AcceptGloveboxSecureKeyOfferToken.js: Z 1");
                                    full_text = previous_text + sel.getRangeAt(i).commonAncestorContainer.textContent;
                                } else {
                                    console.log("AcceptGloveboxSecureKeyOfferToken.js: Z 2");
                                    full_text = sel.getRangeAt(i).commonAncestorContainer.textContent;
                                }
                                if (typeof following_text != "undefined") {
                                    console.log("AcceptGloveboxSecureKeyOfferToken.js: Z 3");
                    ...
                    console.log("AcceptGloveboxSecureKeyOfferToken:: Range.startOffset:" + selectStartOffset);

                    var selectEndOffset = sel.getRangeAt(i).endOffset;
                    console.log("AcceptGloveboxSecureKeyOfferToken:: Range.startOffset:" + selectEndOffset);
                    console.log("AcceptGloveboxSecureKeyOfferToken.js: sel.getRangeAt(i).commonAncestorContainer.textContent: " + sel.getRangeAt(i).commonAncestorContainer.textContent);

                    var selection_text = sel.getRangeAt(i).toString();
                    var rangesize = selection_text.length;
                    console.log("AcceptGloveboxSecureKeyOfferToken:: Range.size:" + rangesize);
                    console.log("AcceptGloveboxSecureKeyOfferToken.js: sel.getRangeAt(i).commonAncestorContainer.textContent: " + sel.getRangeAt(i).commonAncestorContainer.textContent);
                    ...
                    console.log("AcceptGloveboxSecureKeyOfferToken:: Range.startContainer:" + fulltextofnode);
                    ...
                    console.log("AcceptGloveboxSecureKeyOfferToken:: preceeding: " + preceeding);
                    console.log("AcceptGloveboxSecureKeyOfferToken.js: sel.getRangeAt(i).commonAncestorContainer.textContent: " + sel.getRangeAt(i).commonAncestorContainer.textContent);

                    var following = fulltextofnode.substring(selectStartOffset + rangesize);

                    console.log("AcceptGloveboxSecureKeyOfferToken.js: following: " + following);
                    ...
                    console.log("AcceptToken_secure: this text has to contain the Glovebox header:" + full_text);
                    ...
                    var k = 0;
                    while ((match3 = glovebox_header_regex.exec(full_text)) != null && k < 100) {
                        console.log("AcceptGloveboxSecureKeyOfferToken: contains##: selection begin: " + selectStartOffset + " end" + selection_end_pos);
...
browser.runtime.onMessage.addListener(Get_AcceptedGloveboxSecureKeyOfferToken);
