...
function Get_GloveboxSecureKeyTokenFromAcceptedOfferToken(request, sender, sendResponse) {

    var replacementStr = request.Get_GloveboxSecureKeyTokenFromAcceptedOfferToken_replacement;
    console.log("Get_GloveboxSecureKeyTokenFromAcceptedOfferToken: JSON(request): " + JSON.stringify(request));

    console.log("Get_GloveboxSecureKeyTokenFromAcceptedOfferToken: replacement text: " + replacementStr);
        ...
        if (typeof window.getSelection != "undefined") {
            ...
            if (sel.rangeCount) {
                ...
                for (var i = 0, len = sel.rangeCount; i < len; ++i) {
                    ...
                    console.log("Get_GloveboxSecureKeyTokenFromOffer.js: sel.getRangeAt(i).commonAncestorContainer: " + sel.getRangeAt(i).commonAncestorContainer);
...
var start_token_node;
                    ...
                    const glovebox_header_regex = new RegExp('(:GloveboxSecureKeyTokenFromAcceptedOfferToken:[^:]*:)', 'm');
...
browser.runtime.onMessage.addListener(Get_GloveboxSecureKeyTokenFromAcceptedOfferToken);
